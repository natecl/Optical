...
export default function MicrophoneInput() {
    ...
    return (_jsx("button", { onClick: toggleMic, className: `p-4 rounded-full transition-all duration-300 ${isListening ? 'bg-red-500 hover:bg-red-600' : 'bg-white/10 hover:bg-white/20'} text-white shadow-lg`, children: isListening ? 'Stop Listening' : 'Start Listening' }));
}
